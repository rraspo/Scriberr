...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/speakers/reconcile/batch": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "description": "Batch reconciliation options",
                        "name": "request",
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/api.ReconcileBatchRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.ReconcileBatchResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
